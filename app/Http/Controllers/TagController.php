...
class TagController extends AppBaseController
{
    ...
    public function store(CreateTagRequest $request)
    {
        ...
        Flash::success(ucfirst(config('settings.tags_label_singular')) . " ذخیره شد");
    ...
    public function update($id, UpdateTagRequest $request)
    {
        ...
        Flash::success(ucfirst(config('settings.tags_label_singular')) . ' به روز رسانی شد');
    ...
    public function destroy($id)
    {
        ...
        Flash::success(ucfirst(config('settings.tags_label_singular')) . ' حذف شد');
        return redirect(route('tags.index'));
    }
}

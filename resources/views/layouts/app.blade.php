...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/lte/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/lte/bootstrap-toggle.min.css')}}">
    {{-- <link rel="stylesheet" href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css"> --}}
    <link rel="stylesheet" href="{{asset('css/lte/font-awesome.min.css')}}">
    {{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> --}}
    <link rel="stylesheet" href="{{asset('css/lte/select2.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('css/lte/_all.css')}}">
    {{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/iCheck/1.0.2/skins/square/_all.css"> --}}
    <link rel="stylesheet" type="text/css" href="{{asset('css/lte/daterangepicker.css')}}" />
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{route('admin.dashboard')}}" class="hidden-xs logo">
                ...
                <span class="logo-lg"><b style="font-size: 26px">{{config('settings.system_title')}}</b></span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! Auth::user()->name !!}
                                        <small>{!! Auth::user()->created_at->format('M. Y') !!} عضو سیستم از</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('profile.manage')}}" class="btn btn-default btn-flat">پروفایل</a>
                                    </div>

            ...
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header no-border text-center">
                        <h3 class="box-title">آپلود سریع</h3>
                    ...
                    <div class="box-body">
                        <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                            <div class="form-group">
                                <label for="">انتخاب {{ucfirst(config('settings.document_label_singular'))}}</label>
            ...
            <div class="col-sm-12">
                <div class="box box-default">
                    <div class="box-header no-border">
                        <h3 class="box-title">فعالیت ها</h3>
                        ...
                        <div class="box-tools pull-right">
                            {!! Form::open(['method' => 'get','style'=>'display:inline;']) !!}
                                ...
                                <button type="button" id="activityrange" class="btn btn-default btn-sm">
                                    ...
                                    <span>انتخاب تاریخ</span> <i class="fa fa-caret-down"></i>
                                </button>
                                {!! Form::button('<i class="fa fa-filter"></i>&nbsp;فیلتر', ['class' => 'btn btn-default btn-sm','type'=>'submit']) !!}
                            {!! Form::close() !!}
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                    class="fa fa-minus"></i>
                            </button>
                    ...
                    <div class="box-body">
                        <ul class="timeline">
                            <li class="time-label">
                                ...
                                {{-- <span class="bg-red">{{jdate(formatDate(optional($activities->first())->created_at,'d M Y'))->format('y/m/d')}}</span> --}}
                            </li>
                            @foreach ($activities as $activity)
                                ...
                                <li>
                                    ...
                                    <div class="timeline-item">
                                            <span class="time" data-toggle="tooltip" style="direction: rtl"
